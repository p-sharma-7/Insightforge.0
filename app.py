...
##Machine learning application
        ...
        if data is not None:
            ...
            if algo_choice == "Automatic Algo Selection":
                ...
                report = model_trainer.train_model(train_array, test_array)
                best_model_name = model_trainer.get_best_model_name(report)
                st.write(f"Best Model Name: {best_model_name}")
                st.write(f"Best Model Score: {report[best_model_name]}")
